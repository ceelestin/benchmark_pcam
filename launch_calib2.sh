...
#SBATCH --job-name=pcam_calib2
#SBATCH --output=slurm_output/calib2_%a.out
#SBATCH --error=slurm_output/calib2_%a.out
...
params=$(awk -v  idx_param="${SLURM_ARRAY_TASK_ID}" 'NR==idx_param' configs/redundancy_calibration_100seeds_2sizes.txt)
