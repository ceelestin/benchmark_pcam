...
#SBATCH --job-name=pcam_round3
#SBATCH --output=slurm_output/round3_%a.out
#SBATCH --error=slurm_output/round3_%a.out
...
params=$(awk -v  idx_param="${SLURM_ARRAY_TASK_ID}" 'NR==idx_param' configs/redundancy_round3_50seeds_3sizes.txt)
