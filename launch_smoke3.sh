...
#SBATCH --job-name=pcam_smoke3
#SBATCH --output=slurm_output/smoke3_%a.out
#SBATCH --error=slurm_output/smoke3_%a.out
...
params=$(awk -v  idx_param="${SLURM_ARRAY_TASK_ID}" 'NR==idx_param' configs/smoke_round3.txt)
